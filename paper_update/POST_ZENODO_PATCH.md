...
> The artifact is archived at doi: ⟨DOI⟩, which resolves to the `v1.0.3` release
...
> The artifact is released at https://github.com/Sukhmangill977/gc-ir-reference,
> release tag v1.0.3, and archived at doi: ⟨DOI⟩.
...
4. **The deposit must be the `v1.0.3` release**, not a later state of `main`. If
