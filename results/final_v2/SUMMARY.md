...
| Field | Value |
|---|---|
| git commit when this summary was rendered | `c44f25d6fdb67e0bc4ac73a6217125dec8da1c0e` |
| git describe | `preregister-tier0-v2.2-dirty` |
| git tag (exact) | `preregister-tier0-v2.2` |
