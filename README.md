...
> Executed after the public prospective scientific freeze
> `preregister-tier0-v4.1`, pushed to this repository *before* the campaign
> ran and verified from the remote (`preregister-tier0-v4.1` corrects a
> manifest-generation provenance defect in the prior `preregister-tier0-v4`
> tag; the two are scientifically byte-identical — see
> `docs/V4_MANIFEST_DEFECT_REPORT.json`). `results/final_v3_1/`,
> `results/final_v3/`, `results/final_v2/`, and `results/final/` hold
> superseded campaigns, retained unedited for historical comparison, governed
> by the earlier `preregister-tier0-v3.1`/`v3`/`v2.2`/`v1` freezes.

---

<!-- BEGIN CURRENT RELEASE RESULTS (v1.1.0 / final_v4_1) -->
## Current release: v1.1.0

**Reportable campaign:** `results/final_v4_1/`<br>
**Scientific freeze:** `preregister-tier0-v4.1`<br>
**Freeze commit:** `efe4e165619ecb5d781fb795113f33720794a2e5`<br>
**Manifest:** 461 files, 32 roles, root `0640ad1e7a703879d4b9083a088f5b562b638173590292a2c1aed1625102e0e6`

| | Case A | Case B v1.1 |
|---|---|---|
| Bundle SHA-256 | `f5cbc3a8016159d2074005fa021bf76ca04fb7aed1408f5ec845418460a43536` | `0d8b602a4c8af888beb27058b7217893eff92d2f9df7f2944d35347c1031cfc1` |
| Q1-Q10 | 10/10 | 10/10 |
| Determinism (paired, 62 runs total) | 1.000 | 1.000 |
| Monte Carlo max FP_heat | 0.321268 (risk R-06) | 0.31798 (risk B-01) |

Case B v1.1 structure: 6 risks, 9 Approved Control Specifications, 9 risk-derived predicates, 3 compiler invariants, 12 predicates total.

**Negative fixtures:** 19/19 detected (covering the ten canonical queries above; not ten additional queries).

**Case B v1.1 injections (13 scenarios):** authorization_decision {'DENY': 8, 'HOLD': 4, 'PERMIT': 1}; release_decision {'ALLOW_RELEASE': 12, 'BLOCK_RELEASE': 1} -- release_decision is not a fourth peer authorization outcome.

**Tests:** 446 passed, 0 failed, 0 skipped.

**ieee-check-v4:** PASSED (3 stages). **Freeze verification:** PASS (45 checks, 0 failures).

**L-DREA/ULB:** original 284,807-row experiment (https://github.com/AGLakhowal/Gamma-Permit-Package.git @ `40fa8f046ad3`) reproduced fresh, unmodified: 492 fraud-labelled, 0 false permits, 0 false denials. GC-IR predicate-family correspondence: 4 exact, 3 family, 5 not_established. No new v1.1 corpus replay was executed; no fraud-detection claim is made.
...
This section is generated by `python tools/update_readme_current_release.py`; check it without modifying README with `python tools/update_readme_current_release.py --check`.
<!-- END CURRENT RELEASE RESULTS -->
