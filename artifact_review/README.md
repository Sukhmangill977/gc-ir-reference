...
| **Artifact release** | `v1.0.2` — packaging and reviewer documentation only; the scientific results remain those of the freeze above. `v1.0.1` and `v1.0.0` are retained unrewritten. |
